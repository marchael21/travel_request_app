...
<div class="container">
    ...
    <div class="row">
    	...
    	<div class="col-md-12 border-bottom d-flex justify-content-between mb-5">
			<h4 class="pt-2">Approve Booking<small class="ml-2">&nbsp;<i class="fas fa-angle-double-right"></i>&nbsp;List</small></h4>
		</div>

		<!-- Page Content -->
        <div class="col-md-12">
            <form id="search-form" method="GET" action="{{ url('approve-booking') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-success btn-sm" href="{{ url('approve-booking/'.$booking->booking_number) }}" title="Approve Booking"><i class="fas fa-clipboard-check fa-lg"></i>&nbsp;Approve</a>
                            </td>
                        </tr>
                        @endforeach
                        @else 
                        <tr>
                            <td class="text-center" colspan="5">No booking/s yet for approval</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
