...
@section('tab')
<div class="mt-4">
	<form id="search-form" method="GET" action="{{ url('assigned-booking/completed') }}">
	...
	<div class="float-right mb-3">
		<a href="{{ url('assigned-booking/completed') }}" class="btn btn-warning btn-sm" id="clear-search-btn" type="button"><i class="fas fa-sync-alt"></i>&nbsp;Clear Search</a>
